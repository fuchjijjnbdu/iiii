...
bot = telebot.TeleBot('7687762101:AAHP9hEvGgz0ZJfLJLzCvgywmHHykvC0UiE')
...
#  Join Official Channel @H3X_neeraj
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @H3X_neeraj."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @H3X_neeraj ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 180:
                response = "Error: Buy From @H3X_neeraj For More Time"
            else:
...
3. MAKE SURE YOU JOINED https://t.me/+TRmOsvb_MG84YWM9 OTHERWISE NOT WORK
